...
@f = common global float 0.0, align 4
@pi = common global i32* null, align 8
@pc = common global i8* null, align 8
@pf = common global float* null, align 8
@j = global i32 123, align 4
@d = global i8 83, align 1
@g = global float 0x4012449ba0000000, align 4
@pj = global i32* @j, align 8
@pd = global i8* @d, align 8
@pg = global float* @g, align 8
@ppj = global i32** @pj, align 8
@ppd = global i8** @pd, align 8
@ppg = global float** @pg, align 8
